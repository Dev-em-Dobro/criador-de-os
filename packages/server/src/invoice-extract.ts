...
const PROMPT = [
  ...
  'Para cada item, marque se é RECORRENTE (assinatura/ferramenta/SaaS/plano mensal) ou pontual, e',
  'escolha EXATAMENTE UMA categoria desta lista (não invente categoria):',
  '- Marketing / CRM: e-mail marketing, CRM, automação de mensagens (ActiveCampaign, Clint, ManyChat, Unnichat, RD Station, HubSpot).',
  '- IA: modelos e APIs de IA (Anthropic, Claude, OpenAI, ChatGPT, Gemini, ElevenLabs, Midjourney).',
  '- Infra / Dev: hospedagem, nuvem, domínios, ferramentas de dev (AWS, Vercel, GitHub, Cloudflare, hospedagem, VPS).',
  '- Produtividade: trabalho, vídeo, design, colaboração (Zoom, StreamYard, Notion, Canva, Google Workspace, Panda Video, Figma).',
  '- Tráfego pago: anúncios (Facebook/Meta Ads, Google Ads, TikTok Ads, LinkedIn Ads).',
  '- Educação: cursos, faculdade, mentorias, plataformas de ensino.',
  '- Financiamento: parcelamentos, empréstimos, financiamento de compra.',
  '- Viagem: passagens, hotéis, transporte, Uber/99, combustível.',
  '- Fiscal: contabilidade, emissão de notas, ferramentas fiscais (Notazz, contador).',
  '- Telefonia: telefone, celular, internet/dados móveis.',
  '- Impostos (IOF): IOF, tarifas e juros do próprio cartão.',
  '- Outros: só quando realmente não encaixar em nenhuma acima.',
