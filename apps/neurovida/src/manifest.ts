    ...
    menus: [
      // 1) FINANCEIRO — Fatura do cartão com controle de cortes (bloco custom).
      {
        ...
        assistant: {
          ...
          subtitle: 'Faturamento, custos, margem e caixa do seu negócio',
          icon: 'Sparkles',
          analyzeLabel: '📊 Diagnóstico financeiro completo',
          starters: [
            'Como está minha saúde financeira?',
            'Qual meu lucro e margem?',
            'Como está meu caixa?',
            'Onde dá pra cortar custos?',
          ],
        },
            ...
            agents: [
              {
                ...
                icon: '📊',
                status: 'ready',
                expertise: 'Lê seu faturamento, despesas, margem e caixa — aponta onde cortar e como melhorar o resultado.',
                teaser: 'Finanças do negócio',
              },
              {
                contextKey: 'leads',
