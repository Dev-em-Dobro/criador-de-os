...
function buildPrompt(tema: string, slides: number): string {
  return [
    ...
    '',
    '## Regras de conteúdo',
    '- PROIBIDO TRAVESSÃO: em NENHUM texto (título, corpo, legenda, CTA) use travessão',
    '  "—" nem meia-risca "–" — isso deixa com cara de texto gerado por IA. Reescreva',
    '  com vírgula, ponto, dois-pontos ou parênteses, ou quebre em duas frases. Evite',
    '  também reticências "…". Hífen "-" só em palavras compostas (ex.: bem-estar).',
