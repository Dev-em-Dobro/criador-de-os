...
| **F003** | **Social Media Estrategista** — analisa o desempenho sob a ótica de **funil de lançamento** (Lead Score), sugere o cronograma semanal já em rascunhos e reaproveita os campeões (repost/remix) sem dar mais trabalho | 🔨 | Reaproveita `conteudo_desempenho`, `conteudo-pipeline.ts` (geração, força formato), board do Cronograma e a Publicação (Fatia 1) | Epic em `docs/stories/epics/social-media-estrategista.md`. Gates: **pilares** de conteúdo, **calendário de lançamento** e **dado real** (sync de Insights). Objetivo do dono: **captar + nutrir leads → lançamento mensal** |
